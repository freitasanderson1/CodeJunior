...
### Práticas Adicionais:
- **Semantic Versioning**: Seguir o [Semantic Versioning](https://www.notion.so/Semantic-Versioning-Software-Engineering-8f5a4574af4f419e9e191435893b5026?pvs=4) para atribuir versões significativas ao software, facilitando a comunicação das mudanças aos usuários.
...
[Link do Canvas](https://canvas-apps.pr.sebrae.com.br/canvas-api/api/v3/canvas/1261034/download?model=0)
##### Parceiros Chave:
